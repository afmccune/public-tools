    ...
    <xsl:template match="ref">
        <xsl:choose>
            ...
            <xsl:when test="@type='issue'">
                <a class="issue-ref">
                    <xsl:attribute name="href">xdoc.php?file=<xsl:value-of select="@issue"/>
            ...
            <xsl:when test="@type='html-issue'">
                <a class="issue-ref">
                    <xsl:attribute name="href">hdoc.php?file=<xsl:value-of select="@issue"/>
                        <xsl:if test="@target">#<xsl:value-of select="@target"/>
                        </xsl:if>
                    </xsl:attribute>
                    <xsl:apply-templates/>
			...
			<div class="image">
				<div class="image-inner">
					...
					<xsl:choose>
						...
						<xsl:otherwise>
							<xsl:variable name="src">img/illustrations/<xsl:value-of select="./@n"/></xsl:variable>
							<a>
								<xsl:attribute name="class">image-expand</xsl:attribute>
								<xsl:attribute name="href">
									<xsl:value-of select="$src"/>
