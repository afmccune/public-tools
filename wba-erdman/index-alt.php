				...
				<div id="content-inner">
					<div id="issue-heading">
						<div class="issue-heading-inner">
							<h1>Transform Erdman (alternate)</h1>
						</div>
					</div>
					<div id="main">
						<div id="allIssues">
					...
					foreach (new DirectoryIterator("old/") as $fn) {
						if (preg_match('/.xml/', $fn->getFilename())) {
							...
							$XMLstring = preg_replace('@<div([1-9]) ([a-zA-Z0-9="\. ]{0,})><pb n="([0-9a-zA-Z]{1,})"[ ]{0,1}/>@', '<pb n="$3"/><div$1 page="$3" $2>', $XMLstring); // for div right before pb
