				...
				<div id="content-inner">
					...
					foreach (new DirectoryIterator("../../bq/docs/") as $fn) {
						...
						if (preg_match('/.xml/', $fn->getFilename())) {
							...
							$XMLstringNew = preg_replace('/=[ ]{0,1}“([-_a-zA-Z0-9\.]{1,})”/', '="$1"', $XMLstringNew);
							$XMLstringNew = preg_replace('/=[ ]{0,1}”([-_a-zA-Z0-9\.]{1,})“/', '="$1"', $XMLstringNew); // quotes are backwards--e.g., for quotes in pb tag between two quotes in text
