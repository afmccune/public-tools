				...
				<div id="content-inner">
					<div id="issue-heading">
						<div class="issue-heading-inner">
							<h1>Word List: Count Instances of Words (multibyte)</h1>
						</div>
					</div>
					<div id="main">
						<div id="allIssues">
							...
							if (preg_match('/_huge-text/', $fn->getFilename())) {
								...
								foreach($seek as $keyword) {
									if(in_array($keyword, $countedWords)) {
										...
										$count = mb_substr_count($fn_t['text'], ''.$keyword.''); // note that, unlike "preg_match_all" this can't check for word-breaks before and after
